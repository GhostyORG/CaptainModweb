            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        <img width="32" className="rounded-full icon-glow" src="https://cdn.discordapp.com/attachments/970062803497021470/1003409831266365541/unknown.png" />
                        <p className=" font-extrabold ml-1 text-2xl">CaptainMod</p>
                    </div>
                    ...
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            ...
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">Captain</span>Mod</a>
                            </p>
                        </div>
